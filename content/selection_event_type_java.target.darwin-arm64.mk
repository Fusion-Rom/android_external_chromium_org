...
LOCAL_MODULE := content_selection_event_type_java_gyp
LOCAL_MODULE_STEM := selection_event_type_java
...
### Generated for rule "content_content_gyp_selection_event_type_java_target_generate_java_constants":
# "{'inputs': ['../build/android/gyp/util/build_utils.py', '../build/android/gyp/gcc_preprocess.py', 'browser/renderer_host/input/selection_event_type_list.h'], 'extension': 'template', 'outputs': ['$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/%(INPUT_ROOT)s.java'], 'variables': {'output_path': '$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/%(INPUT_ROOT)s.java'}, 'rule_name': 'generate_java_constants', 'rule_sources': ['public/android/java/src/org/chromium/content/browser/input/SelectionEventType.template'], 'action': ['python', '../build/android/gyp/gcc_preprocess.py', '--include-path=..', '--output=$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/%(INPUT_ROOT)s.java', '--template=$(RULE_SOURCES)'], 'message': 'Generating Java from cpp template $(RULE_SOURCES)'}":
$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/SelectionEventType.java: gyp_local_path := $(LOCAL_PATH)
$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/SelectionEventType.java: gyp_var_prefix := $(GYP_VAR_PREFIX)
$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/SelectionEventType.java: gyp_intermediate_dir := $(abspath $(gyp_intermediate_dir))
...
GYP_GENERATED_OUTPUTS := \
	$(gyp_shared_intermediate_dir)/templates/org/chromium/content/browser/input/SelectionEventType.java
...
gyp_all_modules: content_selection_event_type_java_gyp

# Alias gyp target name.
.PHONY: selection_event_type_java
selection_event_type_java: content_selection_event_type_java_gyp
